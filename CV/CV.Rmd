...
tribble(
  ~ Degree, ~ Year, ~ Institution, ~ Where, ~Why,
   "PhD in Linguistics", "2017-", "KU Leuven", "Leuven, Belgium", "Ongoing",
...
tribble(
  ...
  "Sep-Dec 2020", "Lexical Semantics and Lexicology (Collaborator)", "KU Leuven", "Leuven, Belgium", "Advanced Master in Linguistics",
  "Jan 2020", "Distributional Semantics (Collaborator)", "Tilburg University", "Tilburg, Netherlands", "Winter LOT School",
  "Sep-Dec 2019", "Lexicology and Morphology (Collaborator)", "KU Leuven", "Leuven, Belgium", "Master in Linguistics",
  "Sep-Dec 2018", "Lexicology and Morphology (Collaborator)", "KU Leuven", "Leuven, Belgium", "Master in Linguistics",
  "Mar 2016-Oct 2017", "Linguistics I (TA)", "Universidad Nacional de Córdoba", "Córdoba, Argentina","Degree in Italian Language and Literature (Licenciatura, Profesorado, Traductorado)"
) %>%
  detailed_entries(
